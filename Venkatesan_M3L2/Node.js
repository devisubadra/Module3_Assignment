...
const url = 'mongodb+srv://dvenka12:Devisubadra5@m3a1cluster.ocxtahc.mongodb.net/?retryWrites=true&w=majority';
...
app.get('/items', async (req, res) => {
    try {
        const db = client.db('SchoolDetails');
        const collection = db.collection('Student_Information');
